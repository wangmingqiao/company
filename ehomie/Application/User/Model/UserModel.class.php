...
class UserModel extends Model {
    ...
    protected $_validate = array(
        ...
        //array('username', 'email', '邮箱格式不正确', self::EXISTS_VALIDATE, 'regex', self::MODEL_INSERT),
        array('username', '1,32', '邮箱长度为1-32个字符', self::EXISTS_VALIDATE, 'length', self::MODEL_INSERT),
        ...
        array('email', '', '该邮箱已注册', self::MUST_VALIDATE, 'unique', self::MODEL_INSERT),
    );
