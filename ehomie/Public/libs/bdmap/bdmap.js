...
function show_map(objname,options){
    if(options){
    ...
    cr.addCopyright({id: 1, content: "<a href='http://www.corethink.cn' style='font-size:12px;'>CoreThink</a>", bounds: bs});
    ...
    //创建标注
     var myIcon = new BMap.Icon(window.OpenCMF.PUBLIC+ "/libs/bdmap/bdmap.png", new BMap.Size(29, 29));
...
function get_address(callBackFun, spStr){
